...
- Synthesis: [[Research - Gut Optimization Masterclass]]
- Key finding: Full gut masterclass complementing existing [[Gut Health Foods Tier List]]/[[Gut Microbiome Fundamentals]]. **WHY**: gut is a metabolic organ reaching brain (vagus/HPA/tryptophan), ~70% of immune system, SCFA/butyrate payoff, vitamin K/B synthesis, and a barrier that gates systemic inflammation. **LEAKY GUT** = increased intestinal permeability (tight junctions loosen → LPS/flagellin translocate → inflammation) — a REAL mechanism but OVERSOLD as a consumer diagnosis; symptoms (bloat/fatigue/brain fog/skin) are non-specific. **HARMFUL tier (worst-first)**: dietary emulsifiers CMC/polysorbate-80 are the standout villain (non-reversibly alter human microbiota at 0.1% — Chassaing/*Microbiome* 2021 + FRESH RCT), then alcohol, frequent NSAIDs, unnecessary antibiotics (F-tier); UPFs/artificial-sweeteners/refined-sugar/chronic-stress (D-tier); gluten & lectins OVERSTATED for non-coeliacs (B-tier). **GOOD-actions tier**: fermented foods daily + 30 plants/wk + fiber + cut emulsifiers (S-tier; Stanford *Cell* 2021 RCT: fermented foods ↑diversity + ↓19 inflammatory markers incl IL-6 in 10wk, fiber alone didn't ↑diversity short-term). **TESTS**: the headline "leaky gut" **zonulin** test is INVALID — commercial ELISAs measure "unknown proteins," correlate R≈0.03–0.17 with real permeability (*Gut* BMJ 2021); the validated functional test is **lactulose:mannitol** (healthy ~0.014 vs untreated coeliac ~0.133, AUC 0.88); **calprotectin** = clinical inflammation test of choice; microbiome sequencing is descriptive-not-diagnostic; free DIY = Bristol chart + food journal + transit time + plant-diversity count. Minimum protocol: fermented food daily + 30 plants/wk + fiber default + drop emulsifier-laden UPFs + sleep/exercise/stress.
