...
- Updated: [[Wiki Index]], [[Wiki Log]], [[Hot Cache]]
- Key findings: (1) EEE 352 (Properties of Electronic Materials) is the destination of all Terms 1–4 — CHM 114 (crystal structure/doping), PHY 241 (Fermi-Dirac/band theory), EEE 241 (carrier drift fields), and MAT 267/275 (vector calc + DiffEQ for continuity equations) are all coordinated runway to this one gateway course; (2) PHY 241 (Modern Physics) is the most underestimated EE course — it answers WHY silicon has a 1.1 eV bandgap via quantum mechanical band theory and Fermi-Dirac statistics; without PHY 241, EEE 352 is memorized rules; with it, it's derived from first principles; (3) EEE 334 creates a deliberate pedagogical inversion — students learn to USE diodes and transistors as circuit models before they understand the physics; EEE 352/436 then reveal what was happening inside those models; (4) the 7 Area Pathways are 7 distinct semiconductor application domains: EEE 304 (DSP/signals), EEE 333 (FPGA/digital), EEE 335 (analog ICs), EEE 341 (RF/microwave), EEE 352 (device physics), EEE 360 (WBG power), EEE 394 (quantum devices); choosing 4 of 7 = choosing your semiconductor specialization; (5) EEE 350 (Random Signal Analysis) is semiconductor noise physics in disguise — thermal noise = Fermi-Dirac statistics (kT/q), shot noise = charge quantization (Q=ne), 1/f noise = MOSFET oxide-semiconductor interface carrier trapping; (6) the Power track (EEE 360 → EEE 470 → EEE 472) shows semiconductors at physical extremes — SiC (3.2 eV) and GaN (3.4 eV) bandgaps enable 4× higher breakdown field than Si, 10× lower on-resistance at same blocking voltage; EEE 352 explains the physics, EEE 472 teaches converter design; (7) EEE 120 → EEE 333 → EEE 425 is the full transistor→computer chain: Boolean logic in CMOS gates → Verilog HDL synthesis → VLSI transistor-level timing; one MOSFET, tiled 10B times; (8) EEE 488/489 forces synthesis: the prereqs (EEE 241 + EEE 334 + EEE 350 + 3 pathways) ensure every senior project integrates EM constraints, semiconductor circuit models, noise limits, and domain expertise into a physical system
...
- Updated: [[Books]] (domain), [[Wiki Index]], [[Wiki Log]], [[Hot Cache]]
- Key findings: (1) The biography was Jobs's own initiative — he gave Isaacson unprecedented access and zero editorial control; Tim Cook and Jony Ive both publicly disavowed it, suggesting the candor Jobs authorized came at too high a price to his reputation; (2) The Reality Distortion Field (coined Bud Tribble 1981, appears 34× in the book) is the central organizing concept — the same trait drove Apple's greatest achievements AND led Jobs to delay cancer surgery for 9 months; (3) The Pixar gamble — buying it from Lucas for $5M in 1986 and funding it through a decade of losses — was Jobs's greatest act of vision; Toy Story (1995) made him a billionaire and proved the end-to-end integration model that became the iPhone; (4) His most important leadership skill was knowing what to say no to: when he returned to Apple in 1997 he cut from 350 products to 10 using one filter — would he be embarrassed to give this to a friend?; (5) The Reed College calligraphy class (audited after dropping out) directly caused the Mac's multiple fonts and proportional spacing — the first personal computer to take typography seriously; the prototype example of "connecting dots backward"; (6) He ran Apple as a product company, not a profit company — "If you don't cannibalize yourself, someone else will"; Apple became the world's most valuable company precisely because profit was never the primary objective; (7) The iPhone (2007) did not improve on existing phones — it made the category irrelevant; key decisions: eliminate stylus, full multi-touch, Gorilla Glass (didn't yet exist commercially — Jobs called the CEO and said "you need to make this for us"), full internet browser in pocket; (8) Jobs's lasting contribution to innovation theory is the "intersection thesis" — the greatest work happens at the crossroads of humanities and sciences; his calligraphy, Zen Buddhism, Beatles love were not backstory — they were the mechanism; Apple won not by having better engineers but by holding engineers and artists to the same standard in the same room
...
- Updated: [[Theology]], [[Wiki Index]], [[Wiki Log]], [[Hot Cache]]
- Key findings: (1) The Eucharist and Confession are the non-negotiable sacramental foundation — the Catechism calls the Eucharist "the source and summit of Christian life" (CCC 1324); weekly Mass + monthly Confession form the irreplaceable backbone that no amount of private prayer can substitute; (2) Personal daily prayer (minimum 15 min) is the relational practice that builds intimacy — consistency beats duration; the three most powerful structured methods are Lectio Divina (sacred reading in 4 movements), the Ignatian Daily Examen (5-step evening review), and the Liturgy of the Hours; (3) The Three Ways (Purgative → Illuminative → Unitive) map spiritual growth non-linearly — most Catholics are in the Purgative or early Illuminative Way; aridity and dryness in prayer is a sign of progress in the Illuminative Way, not abandonment or failure — the correct response is to continue faithfully without seeking felt consolation; (4) The Rosary is the most accessible deep-prayer practice for laypeople — Pope Paul VI called it "a compendium of the entire Gospel"; it is a structured Gospel meditation on 20 mysteries of Christ's life through Mary's eyes; Mary leads to Jesus, not away from Him; (5) Spiritual reading of the classics is high-ROI and underused — *The Imitation of Christ* (Kempis, c.1420) and *Introduction to the Devout Life* (de Sales, 1609) are the two most universally recommended books in the Catholic tradition for laypeople; 15 min/day of slow, prayerful reading compounds dramatically; (6) Fasting, mortification, and almsgiving form the ascetical backbone — the threefold practice (prayer + fasting + almsgiving) is interconnected; fasting purifies the senses and unites the body to Christ's passion; the Church requires abstaining from meat on Fridays (or substitute penance) and full fasting on Ash Wednesday and Good Friday; (7) Spiritual direction is the single most underutilized growth accelerant — a one-on-one monthly relationship with a trained guide focused on discerning God's action in your life; not counseling but guided listening; St. Francis de Sales: "a spiritual director perfects the individual"; start by asking your parish priest; (8) Community involvement and works of mercy multiply everything — 80% of parishioners in Catholic small groups maintained or grew faith during COVID vs. isolated individuals; the Corporal and Spiritual Works of Mercy exercise the theological virtues and encounter Christ concretely in the poor ("whatever you did for the least of these" — Mt 25:40)
