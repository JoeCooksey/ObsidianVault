...
- [[Problem-Solving Practice Activities (Concrete Menu)]] — **where to actually go**: specific problem sources by domain — programming (NeetCode 150, LeetCode, CSES, Codeforces), math (Project Euler, AoPS, How to Prove It), EE (Sedra/Smith, Falstad predict-then-sim, his buck project) + a sample interleaved week (developing)
...
- [[Research - Do Vegetables Destroy Metabolism and Gut Health]] — **synthesis** (2026-06-16): answers "do vegetables wreck metabolism/gut?" → strong carnivore claim is mostly BS (food matrix neutralizes anti-nutrients; fiber→butyrate maintains gut mucus barrier; goitrogens don't slow thyroid at normal intake; more veg = LESS metabolic disease) but 2 real kernels: low fiber helps idiopathic constipation (Ho 2012) + low-FODMAP helps IBS; error = generalizing sick-gut relief to "plants are toxic for all" (developing)
- [[Dietary Fiber and Gut Health]] — the fiber/microbiome half: fiber→SCFA/butyrate fuels colonocytes + builds mucus barrier; fiber deprivation thins mucus & cuts diversity; kernels of truth = Ho 2012 constipation + low-FODMAP IBS + IBD flares; "fiber is a myth" is a hasty generalization (developing)
- [[Do Vegetables Slow Metabolism (Claim Review)]] — the metabolism half: goitrogen/thyroid claim fails at normal+cooked intake with iodine; veg fiber doesn't slow metabolic rate; anti-nutrient mineral-binding is meal-specific; population data inverted (more veg = less diabetes/obesity) (developing)
- [[Perceived Problematic Plant Compounds (Narrative Review)]] · [[Harvard Nutrition Source - Are Anti-Nutrients Harmful]] · [[Fiber Gut Microbiome and SCFA Research]] · [[Ho 2012 - Reducing Dietary Fiber and Constipation]] · [[Low-FODMAP Diet for IBS Evidence]] · [[Fruit and Vegetable Intake and Mortality]] — sources for the above
...
### Inflammation / hs-CRP (2026-07-26)
- [[Research - Habits That Raise and Lower hs-CRP]] — **synthesis**: full breakdown of what moves hs-CRP. ⬇️ lower = exercise (works even without weight loss, Fedewa 2016), fat loss, Mediterranean/low-DII diet, omega-3, coffee (inverse!), good sleep, quitting smoking, stress reduction. ⬆️ raise = excess body fat (master variable), smoking, poor/short/long sleep (U-shape), pro-inflammatory diet, heavy alcohol, chronic stress, sedentary living. Adiposity mediates most of it (developing)
- [[hs-CRP (High-Sensitivity C-Reactive Protein)]] — the biomarker: <1 low / 1–3 avg / >3 high CV risk, >10 = retest; Tier-1 modifiable inflammation marker; responds to habits in weeks–months (developing)
- [[Dietary Inflammatory Index]] — scores a whole diet anti- → pro-inflammatory; high-DII tracks higher CRP; pattern captures most of the signal (developing)
- Sources: [[Fedewa 2016 — Exercise Training and CRP Meta-Analysis]] · [[Irwin 2016 — Sleep Disturbance and Inflammation Meta-Analysis]] · [[Koelman 2022 — Dietary Patterns and Inflammation RCT Meta-Analysis]] · [[Ge 2020 BMJ — Named Diets and Cardiovascular Risk Factors]] · [[Choi and Je 2024 — Coffee Consumption and CRP Meta-Analysis]] · [[Kavyani 2022 — Omega-3 and Inflammatory Biomarkers Umbrella Meta]] · [[Bakhru 2005 — Smoking Cessation and Inflammatory Markers (NHANES III)]] · [[Xu 2016 — Alcohol Use and hs-CRP (Guangzhou Biobank)]] · [[Pascoe 2017 — Mindfulness Meditation and Stress Markers Meta-Analysis]] · [[Bastos 2024 — Dietary Inflammatory Index and Systemic Inflammation]]
...
- [[Most Important Biomarkers (Priority Shortlist)]] — the "what to actually look at" filter on a 100+ panel: Tier 1 = ApoB/Lp(a)/hs-CRP/HbA1c+insulin/ALT-AST/Tg:HDL; Tier 2 = testosterone panel, Vit D, ferritin, omega-3 index, TSH, homocysteine; "normal ≠ optimal" (developing)
- [[Blood Test Preparation Protocol]] — how to prep so the draw measures YOU: fast 8–12h (water only), no intense exercise 48–72h (skews AST/ALT/CK/testosterone), no alcohol 48–72h, hold biotin 72h, morning rested draw, hydrate, keep meds; now includes Joe's stack-specific keep/pause table (pause biotin/creatine/Tier 3/caffeine; keep omega-3/D3+K2/Mg/meds) (stable)
...
- [[Buck Converter BOM (Order-Ready 2026)]] — exact orderable parts list w/ MPNs + June-2026 availability: NUCLEO-G474RE, SRP1265A-330M inductor, FDMS7672/FDS8880 FETs (FDMC8030 dropped — EOL), LM5109B driver, caps/Rs, JLCPCB, Rigol DHO802 scope; ordering strategy + cost roll-up (developing)
...
- [[Video Games Cognitive Benefits]] — S–F tier list of 40+ PC+mobile games ranked by cognitive ROI; Chess/StarCraft II/Portal 2 S-tier; MOBAs A-tier; gacha games F-tier; 2022–2025 IQ evidence update; Joe-specific recommendations (developing)
...
## Questions / Synthesis
- [[Research - Udemy Personal Plan Course Roadmaps for an EE Career]] — **synthesis + 6 roadmaps**: "Udemy premium" = [[Udemy Personal Plan]], $35/mo list ($24.50 promo), **28,000 of 250,000 courses (~11%)**, curated at a ~4.5★ bar. Marketing never says "engineering" but coverage is real and uneven — verified by browser audit of the **"Premium" inclusion badge** ([[Udemy Personal Plan EE Coverage Map]]). Excellent: embedded (76h STM32/ARM ladder), PCB (112h flagship, 4.7/19,309), MATLAB/Simulink. Weak: FPGA (VHDL/Intel only — Verilog/Xilinx excluded). **Absent: LTspice (1 of 17) and WBG device physics (nowhere on the platform)**. Access is rented + non-refundable → use as a **2–3 month sprint, not a library**; certificate worthless, artifact is everything (developing)
...
- [[Research - Summer Part-Time Job Guide Livermore College Student]] — full guide: 8 findings, platform tier list, LARPD/Tri-Valley Career Center/retail employer table, 4 job categories, resume guide, Joe-specific action stack (complete)
...
- [[Research - Norwegian 4x4 HIIT Masterclass (Running and Rowing)]] — full masterclass: protocol table, format-beats-intensity, pace-for-the-4th-rep, HR reality (~93% peak), running (treadmill ≥5% incline) + rowing (2K+2–5 s, 28–32 spm, drag 120–130) execution; ~7–13% VO2max in 8 wk + Generation 100 longevity; now includes [[Getting Your Heart Rate Up on the Rower]] (updated 2026-06-29) (developing)
...
- [[Research - Video Game Tier List to Increase IQ]] — IQ-specific lens on the games tier list; +2.5 IQ in kids (Karolinska/ABCD), MOBAs track fluid intelligence, 2025 action>strategy contradiction, brain-training far-transfer is null (developing)
...
- [[Research - Gut Optimization Masterclass]] — full masterclass: why optimize (gut–brain/immune/SCFA/metabolic/barrier), leaky gut science + symptoms, good-vs-harmful food/action tier lists, valid-vs-invalid tests (zonulin debunked, lactulose:mannitol validated); emulsifiers = #1 dietary villain; minimum effective protocol (developing)
- [[Research - Function Health Test Prep and Priority Biomarkers]] — **synthesis (personalized)**: prep for Joe's upcoming Function draw, built on his last panel (2025-12-29, 120 markers, 13 out-of-range). Headline = high **Lp(a) 152** (genetic, keep other CVD levers tight) + atherogenic LDL-particle pattern + low omega-3; **ALT 69/AST 39 likely exercise artifact → rest 48–72h before re-draw**; prep checklist (fast/morning/no-exercise/no-alcohol/hold-biotin) (developing)
- [[Research - Healthy vs Unhealthy Gut Signs]] — **synthesis**: healthy gut = silent + regular (Bristol 3–4, no straining, transit ~14–58h); frequency = most overrated marker; unhealthy signs tiered by confidence (digestive→food-response→systemic→distal); red flags are a separate category, never self-treat past them (developing)
